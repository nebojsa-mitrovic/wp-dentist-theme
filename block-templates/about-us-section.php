...
$dentist_image_sized = $dentist_image['sizes']['large'];
...
$assistent_image_sized = $assistent_image['sizes']['large'];
...
$second_assistent_image_sized = $second_assistent_image['sizes']['large'];
